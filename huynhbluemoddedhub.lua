...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Image = "http://www.roblox.com/asset/?id=18850953210"..tostring(logo)
	...
	DiscordLib:Notification("Thông Báo" , "Modded By Huynh Blue" , 6 ,11816162894 )
 ...
 local uihide = false
 local abc = false
 local logo = logo or 18850953210
 local currentpage = ""
 ...
 local MainImage = Instance.new("<<<eLabel")
...
--------------------------------------------------------------------
local Library = Update:Window("HuynhBL","")
------------------------------------------
...
Setting:Label("Huynh Blue Mod")

Setting:Line()

Setting:Button("Sao Chép Link Facebook",function()
 
 setclipboard("https://www.facebook.com/imhuynhblue?mibextid=ZbWKwL")
...
ImageLabel.Image = "http://www.roblox.com/asset/?id=18647452108"
...
ImageButton.Image = "rbxassetid://18647452108"
...
for k,v in pairs(ListHuhu) do
    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..k,true) == 1 then 
        ...
        if type(v)=="string" then 
            ...
            huhu.Image = "rbxassetid://18647452108"
